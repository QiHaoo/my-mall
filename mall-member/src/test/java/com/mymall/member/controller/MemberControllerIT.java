...
class MemberControllerIT {
    ...
    static void configureFeignUrl(DynamicPropertyRegistry registry, WireMockRuntimeInfo wmRuntimeInfo) {
    ...
    class TestRemoteIntegration {
        ...
        void setUpWireMockStub() {
            ...
            stubFor(get(urlEqualTo("/coupon/coupon/list"))
        ...
        void shouldCallWireMockAndReturnCoupons() throws Exception {
            ...
            verify(getRequestedFor(urlEqualTo("/coupon/coupon/list")));
        }
    }
}
