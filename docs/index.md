...
- 📐 [开发规范](standards/coding-standards.md) — 分层架构、异常体系、日志、命名规范
- 🗄️ [数据库表设计规范](standards/table-design-specification.md) — 建表模板、审计字段、索引规范
- 🔌 [Controller 接口规范](standards/controller-specification.md) — 参数校验、返回值、URL 设计
- 🧪 [后端测试规范](standards/testing-specification.md) — 测试分层、AssertJ、命名规范
