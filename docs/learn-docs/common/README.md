...
| 统一响应与异常体系 | `R` `ResultCode` `BizException` `GlobalExceptionHandler` | 从 Controller 到 Service 的完整错误处理链路 | [02-response-exception.md](./02-response-exception.md) |
...
| 请求参数基础设施 | `PageQuery` `Create` `Update` | 分页参数统一 + 校验分组设计 | [04-query-validation.md](./04-query-validation.md) |
